...
describe('CharacterStatsAdapter', () => {
  ...
  it('should normal adapt for empty equip', () => {
    const chars = new CharacterEquipAdapter({
      characteristics: {
        attunement: 1,
        charisma: 2,
    ...
    expect(chars.souls).toEqual('16');
    expect(chars.humanity).toEqual('14');
    expect(chars.helmet).toEqual('');
    expect(chars.armor).toEqual('');
    expect(chars.arms).toEqual('');
    expect(chars.legs).toEqual('');
    expect(chars.ring1).toEqual('');
    expect(chars.ring2).toEqual('');
    expect(chars.leftWeapon1).toEqual('');
    expect(chars.rightWeapon1).toEqual('');
    expect(chars.leftWeapon2).toEqual('');
    expect(chars.rightWeapon2).toEqual('');
