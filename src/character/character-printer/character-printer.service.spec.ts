...
describe('CharacterPrinterService', () => {
  let service: CharacterPrinterService;

  beforeEach(async () => {
    service = new CharacterPrinterService();
  });
...
----------------------------------------------------------------------
 ...
 Кольцо:                                                             
 Кольцо:                                                             
 Активное левое оружие:                                              
 Активное правое оружие:                                             
 Не активное левое оружие:                                           
 Не активное правое оружие:                                          
----------------------------------------------------------------------
 Ячеек магии:                                                      43
